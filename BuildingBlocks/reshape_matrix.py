...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/Matrix/Matrix-Essentials/02_reshape_matrix.ipynb.

# %% auto 0
__all__ = ['reshape_matrix']

# %% ../nbs/Matrix/Matrix-Essentials/02_reshape_matrix.ipynb 2
from typing import List, Union
import numpy as np

# %% ../nbs/Matrix/Matrix-Essentials/02_reshape_matrix.ipynb 4
