...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/Matrix/Algebra/08_matrix_inverse.ipynb.

# %% auto 0
__all__ = ['inverse_2x2']

# %% ../nbs/Matrix/Algebra/08_matrix_inverse.ipynb 3
from typing import List, Union
import numpy as np
from .matrix_scalar_multiply import *

# %% ../nbs/Matrix/Algebra/08_matrix_inverse.ipynb 4
